...
This directory contains source files for the Somali language morphology
...
In order to compile and use Somali language morphology and dictionaries,
you need:
...
The Somali language sources can be acquired using [giella SVN
